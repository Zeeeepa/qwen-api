...
Originally located at: test_auth.py (root)
Migrated to: tests/integration/test_auth.py (2025-10-14)
"""
...
# Add project root to path (now 2 levels up from tests/integration/)
...
if HAS_PYTEST:
    ...
    async def test_qwen_authentication():
        """Pytest test for Qwen authentication and token extraction"""
        await main()


async def main():
    """Test authentication and token extraction (can run standalone or via pytest)"""
